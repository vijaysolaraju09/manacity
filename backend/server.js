...
const businessRequestAdminRoutes = require('./routes/businessRequestAdminRoutes');
...
app.use('/api', businessRequestRoutes);
app.use('/api/admin', businessRequestAdminRoutes);
